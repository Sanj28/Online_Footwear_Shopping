...
<h4 class="card-title" style="float:left;">ADMIN DETAILS</h4>
<a href="admin_form.php"><h4 class="card-title" style="float:right;"><button class="btn btn-md btn-info">ADD NEW RECORD</button></h4></a>
</div>
...
while($row=$result->fetch_assoc())
{
    ...
    <tr>
        ...
        <td><a class="btn btn-primary" href="admin_edit.php?id=<?php echo $row['ad_id'];?>">EDIT</a></td>
        <td><a class="btn btn-danger" href="admin_delete.php?id=<?php echo $row['ad_id'];?>">DELETE</a></td>
    </tr>
<?php
}
?>
