...
<form class="form form-horizontal" action="product_category_insert.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<div class="form-body">
<div class="row">

<div class="col-md-12 form-group">
<label>Product Name</label>
<input type="text" class="form-control" name="pc_name" id="pc_name" placeholder="Product Name">
<span id="pc_name_error"></span>

</div><div class="col-md-12 form-group">
<label>Discount</label>
<input type="text" class="form-control" name="pc_discount" id="pc_discount" placeholder="Discount">
...
<script type="text/javascript">
	function ValidateForm()
	{
		var pc_name='';
		var pc_discount='';
        pc_name=alphabets('pc_name','pc_name_error','Product Catrgory Name');
