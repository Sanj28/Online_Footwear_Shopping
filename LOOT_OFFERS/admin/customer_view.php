...
<h4 class="card-title" style="float:left;">CUSTOMER</h4>
...
<!--
                    ...
                    <td><?php //echo $row['cu_password'];?></td>
-->
                    <td><?php echo $row['cu_date'];?></td>
<!--                    <td><a class="btn btn-primary"href="customer_edit.php?id=<?php //echo $row['cu_id'];?>">EDIT</a></td>-->
                    <td><a class="btn btn-danger" href="customer_delete.php?id=<?php echo $row['cu_id'];?>">DELETE</a>
                </tr>
            <?php
            }
            ?>
