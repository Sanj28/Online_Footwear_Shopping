...
<center><h4 class="card-title">TABLE NAME</h4></center>
</div>
<div class="card-content">
<div class="card-body">

<form class="form form-horizontal" action="#" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<div class="form-body">
<div class="row">
...
<script type="text/javascript">
	...
	{
		var name='';
		name=alphabets('name','name_error','Name');
		if(name==1)
		{
			return true;
		}
