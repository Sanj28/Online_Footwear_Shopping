...
<?php
 $cu_id=$_REQUEST["id"];
      $sql=$conn->prepare("SELECT * FROM customer WHERE cu_id=?");
      $sql->bind_param("i",$cu_id);
      $sql->execute();
      $result=$sql->get_result();
      $row=$result->fetch_assoc();
      ?>
<form class="form form-horizontal" action="customer_update.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<input type="hidden" name="cu_id" id="cu_id" value="<?php echo $row["cu_id"];?>">
<div class="form-body">
<div class="row">

<div class="col-md-12 form-group">
<label>Name</label>
<input type="text" class="form-control" name="cu_name" id="cu_name" value="<?php echo $row['cu_name'];?>">
<span id="cu_name_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Contact</label>
<input type="text" class="form-control" name="cu_contact" id="cu_contact" value="<?php echo $row["cu_contact"];?>">
<span id="cu_contact_error"></span>

</div>
<div class="col-md-12 form-group">
<label>Address</label>
<textarea  class="form-control" name="cu_address" id="cu_address"><?php echo $row['cu_address'];?></textarea>
<span id="cu_address_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Email</label>
<input type="text" class="form-control" name="cu_email" id="cu_email" value="<?php echo $row["cu_email"];?>">
<span id="cu_email_error"></span>
    </div>
    
<div class="col-md-12 form-group">
<label>Username</label>
<input type="text" class="form-control" name="cu_username" id="cu_username" value="<?php echo $row["cu_username"];?>" >
<span id="cu_username_error"></span>
    </div>
    
<div class="col-md-12 form-group">
<label>Password</label>
<input type="password" class="form-control" name="cu_password" id="cu_password" value="<?php echo $row["cu_password"];?>">
<span id="cu_password_error"></span>
    </div>
    
<div class="col-md-12 form-group">
<label>Date</label>
<input type="date" class="form-control" name="cu_date" id="cu_date" value="<?php echo date('Y-m-d')?>">
...
<script type="text/javascript">
	function ValidateForm()
	{
        ...
        cu_address=alphabets('cu_address','cu_address_error','Address');
