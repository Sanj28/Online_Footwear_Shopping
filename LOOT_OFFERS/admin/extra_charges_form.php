...
<form class="form form-horizontal" action="extra_charges_insert.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<div class="form-body">
<div class="row">

<div class="col-md-12 form-group">
<label>Minimum Amount</label>
<input type="text" class="form-control" name="ec_min_amount" id="ec_min_amount" placeholder="Minimum Amount">
<span id="ec_min_amount_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Delivary Charges</label>
<input type="text" class="form-control" name="ec_delivery_charges" id="ec_delivery_charges" placeholder="Delivery Charges">
<span id="ec_delivery_charges_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Minimum Stock</label>
<input type="text" class="form-control" name="ec_min_stock_qty" id="ec_min_stock_qty" placeholder="Minimum Stock">
...
<button type="button" class="btn btn-primary mr-1 mb-1" onclick="window.location.href='extra_charges_view.php'">Cancel</button>
</div>
