...
<a href="product_type_form.php"><h4 class="card-title" style="float:right;"><button class="btn btn-md btn-info">NEW</button></h4></a>
</div>
...
<?php
            $sql=$conn->prepare("SELECT * FROM product_category,product_type WHERE product_type.pc_id=product_category.pc_id");
            $sql->execute();                                                           
            ...
            while($row=$result->fetch_assoc())
            {
                ...
                <tr>
                    ...
                    <td><a class="btn btn-danger" href="product_type_delete.php?id=<?php echo $row['pt_id'];?>">DELETE</a></td>
                </tr>
            <?php
            }
            ?>
