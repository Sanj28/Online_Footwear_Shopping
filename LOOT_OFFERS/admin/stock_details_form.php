...
<form class="form form-horizontal" action="stock_details_insert.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<div class="form-body">
<div class="row">
...
<option value="">--SELECT--</option>
<?php
$sql1=$conn->prepare("SELECT * FROM product_size");
$sql1->execute();
$result1=$sql1->get_result();
while($row1=$result1->fetch_assoc())
{
?>
<option value="<?php echo $row1['ps_id']; ?>">
<?php echo $row1['ps_name']; ?>
</option>
<?php
}
?>
...
<input type="text" class="form-control" placeholder="UNIT PRICE" name="pd_price" id="pd_price" readonly onkeyup="calculateprice()" value="<?php if(!empty($_SESSION["pd_price"])){ echo $_SESSION["pd_price"]; }?>">
<span id="pd_price_error"></span>
</div>

<div class="col-md-12 form-group">
<label>INCREMENT AMOUNT</label>
<input type="text" class="form-control" placeholder="INCREMENT AMOUNT" name="sd_increment" id="sd_increment" onkeyup="calculateprice()" value="<?php if(!empty($_SESSION["sd_increment"])){ echo $_SESSION["sd_increment"]; }else{ echo "0";}?>">
<span id="sd_increment_error"></span>
</div>

<div class="col-md-12 form-group">
<label>TOTAL UNIT PRICE</label>
<input type="text" class="form-control" placeholder="TOTAL UNIT PRICE" name="sd_unitprice" id="sd_unitprice" readonly value="<?php if(!empty($_SESSION["sd_unitprice"])){ echo $_SESSION["sd_unitprice"]; }?>">
<span id="sd_unitprice_error"></span>
</div>

<div class="col-md-12 form-group">
<label>DISCOUNT</label>
<input type="text"  class="form-control" placeholder="DISCOUNT" name="sd_discount" id="sd_discount" value="0">
<span id="sd_discount_error"></span>
</div>

<div class="col-md-12 form-group">
<label>AVAILABLE QUANTITY</label>
<input type="number" class="form-control" placeholder="AVAILABLE QUANTITY" name="sd_avail_qty" id="sd_avail_qty" min="1" value="1">
<span id="sd_avail_qty_error"></span>
</div>

<div class="col-md-12 form-group">
<label>MAX ORDER QTY</label>
<input type="number"  class="form-control" placeholder="MAX ORDER QTY" name="sd_max_qty_order" id="sd_max_qty_order" min="1" value="1">
