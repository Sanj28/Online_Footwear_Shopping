...
<form class="form form-horizontal" action="product_details_insert.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
<div class="form-body">
<div class="row">
...
<div class="col-md-12 form-group">
<label>NAME</label>
<input type="text" class="form-control" name="pd_name" id="pd_name" placeholder="Name">
<span id="pd_name_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Image1</label>
<input type="file" class="form-control" name="pd_image1" id="pd_image1" placeholder="Image1" >
<span id="pd_image1_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Image2</label>
<input type="file" class="form-control" name="pd_image2" id="pd_image2" placeholder="Image2" >
<span id="pd_image2_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Image3</label>
<input type="file" class="form-control" name="pd_image3" id="pd_image3" placeholder="Image3" >
<span id="pd_image3_error"></span>
</div>

<div class="col-md-12 form-group">
<label>Image4</label>
<input type="file" class="form-control" name="pd_image4" id="pd_image4" placeholder="Image4" >
<span id="pd_image4_error"></span>
</div>

<div class="col-md-12 form-group">
<label>DESCRIPTION</label>
<textarea class="form-control" name="pd_description" id="pd_description" cols="" rows=""></textarea>
...
<div class="col-md-12 form-group">
<label>PRICE</label>
<input type="text" class="form-control" placeholder="PRICE" name="pd_price" id="pd_price">
