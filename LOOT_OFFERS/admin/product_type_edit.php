...
$pt_id=$_REQUEST["id"];
       ...
       ?>
<form class="form form-horizontal" action="product_type_update.php" enctype="multipart/form-data" method="post" onsubmit="return ValidateForm();">
...
<div class="col-md-12 form-group">
<label>Name</label>
<input type="text" class="form-control" name="pt_name" id="pt_name" value="<?php echo $row["pt_name"];?>">
